class Escena3 extends Phaser.Scene{
    ...
    constructor(){
        ...
        this.scoreText = "";
        this.score = 0;
        this.timeLeft = 60; // tiempo en segundos
    }
    
    
  
    preload(){
        this.load.image('caverna','../public/img/Caverna.png');
    ...
    create(){
      this.score= 0;
        ...
        //para agregar 
        this.timeText = this.add.text(600, 16, 'Tiempo: 60', {
            fontSize: '32px',
            fill: '#FFFF'
          });
    ...
    update(){
        ...
        //se resta el tiempo al contador y se actualiza el texto
        this.timeLeft -= 1 / 60; // Resta 1 segundo por cada segundo (considerando 60 fotogramas por segundo)
